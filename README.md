...
- [conan-io/conan-mcp](https://github.com/conan-io/conan-mcp) 🎖️ 🐍 ☁️ 🏠 🍎 🪟 🐧 - Official MCP server for Conan C/C++ package manager. Create projects, manage dependencies, check licenses, and scan for security vulnerabilities.
